/*
 * File: builtin.c
 * Authors: cynthia kio and obi okoye
 */
#include "shell.h"
...
/**
 * help_all - Helps to displays all possible builtin shellby commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Helps to displays information on the shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Helps to displays information on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit -Helps to displays information on the shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help -Helps to displays information on the shellby builtin command 'help'.
 */
void help_help(void)
{
